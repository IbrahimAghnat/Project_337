  ...
  <div class="c_login-frame1">
    ...
    <form method="post" class="login-form">
      ...
      <div class="input-group password-group">
        ...
        <img id="togglePassword" class="toggle-eye" src="<?= $base_url ?>assets/eye-hide.png" alt="Toggle Password">
      </div>
  ...
  <script>
    ...
    toggle.addEventListener("click", () => {
      if (pwd.type === "password") {
        pwd.type = "text";
        toggle.src = "<?= $base_url ?>assets/eye-show.png"; // ganti ke icon "show"
      } else {
        pwd.type = "password";
        toggle.src = "<?= $base_url ?>assets/eye-hide.png"; // ganti ke icon "hide"
      }
    });
