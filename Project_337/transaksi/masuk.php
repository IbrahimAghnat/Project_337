...
if (isset($_POST['simpan'])) {
  ...
  $conn->query("INSERT INTO tb_stok_detail (id_barang, jumlah, tanggal_expired) 
                  VALUES ('$id_barang', '$jumlah', '$expired')");
  $conn->query("INSERT INTO tb_transaksi (id_barang, id_user, jenis, jumlah, keterangan) 
                  VALUES ('$id_barang', $id_user, 'masuk', '$jumlah', '$ket')");
...
">
  <div style="
    ...
    width:100%; 
    max-width:520px;
    border-top:6px solid #006838ff;
  ">
    <h2 style="color:#006838ff; text-align:center; margin-bottom:28px; font-size:24px; font-weight:700;">
      Barang Masuk
    </h2>
    ...
    <form method="post" style="display:flex; flex-direction:column; gap:20px;">
      ...
      <style>
        ...
        select.form-box {
          background-image: url("data:image/svg+xml;utf8,<svg fill='%23006838ff' height='16' viewBox='0 0 24 24' width='16' xmlns='http://www.w3.org/2000/svg'><path d='M7 10l5 5 5-5z'/></svg>");
      ...
      <div style="display:flex; flex-direction:column; gap:6px;">
        <label style="font-weight:600; color: #006838ff;">Pilih Barang</label>
      ...
      <!-- Jumlah -->
      <div style="display:flex; flex-direction:column; gap:6px;">
        <label style="font-weight:600; color:#006838ff;">Jumlah</label>
        <input type="number" name="jumlah" class="form-box" placeholder="Masukkan jumlah barang" required>
      </div>

      <!-- Tanggal Expired -->
      <div style="display:flex; flex-direction:column; gap:6px;">
        <label style="font-weight:600; color:#006838ff;">Tanggal Expired</label>
        <input type="date" name="expired" class="form-box" required>
      </div>

      <!-- Keterangan -->
      <div style="display:flex; flex-direction:column; gap:6px;">
        <label style="font-weight:600; color:#006838ff;">Keterangan</label>
      ...
      <button type="submit" name="simpan" style="
        ...
        background:linear-gradient(to right, #006838ff, #1f5a0eff); 
